...
const FeaturedRoom: FC<Props> = ({ featuredRoom }) => {
  return (
    <section className="flex md:flex-row flex-col px-4 py-10 items-center gap-12 container">
      ...
      <div className="md:py-10 ms:w-1/2 text-left">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
          ...
          <Link
            ...
            className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold lg:text-lg"
          >
            More Details
          </Link>
        </div>
